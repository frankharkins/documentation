...
<Class id="qiskit.circuit.library.MCMTVChain" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/generalized_gates/mcmt.py#L158-L256" signature="qiskit.circuit.library.MCMTVChain(*gate*, *num\_ctrl\_qubits*, *num\_target\_qubits*)" modifiers="class">
