...
<Function id="qiskit.pulse.library.GaussianDeriv" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/library/symbolic_pulses.py#L1270-L1330" signature="qiskit.pulse.library.GaussianDeriv(*duration*, *amp*, *sigma*, *angle=0.0*, *name=None*, *limit\_amplitude=None*)">
