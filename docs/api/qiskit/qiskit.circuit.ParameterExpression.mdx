...
<Class id="qiskit.circuit.ParameterExpression" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/parameterexpression.py#L33-L548" signature="qiskit.circuit.ParameterExpression(*symbol\_map*, *expr*)" modifiers="class">
  ...
  *   **expr** (*sympy.Expr*) – Expression of `sympy.Symbol` s.
  ...
  <Function id="qiskit.circuit.ParameterExpression.bind" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/parameterexpression.py#L93-L146" signature="bind(*parameter\_values*, *allow\_unknown\_parameters=False*)">
  ...
  <Function id="qiskit.circuit.ParameterExpression.is_real" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/parameterexpression.py#L477-L488" signature="is\_real()">
  ...
  <Function id="qiskit.circuit.ParameterExpression.subs" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/parameterexpression.py#L148-L196" signature="subs(*parameter\_map*, *allow\_unknown\_parameters=False*)">
