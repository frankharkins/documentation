...
<Class id="qiskit.qobj.QobjHeader" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/qobj/common.py#L62-L65" signature="qiskit.qobj.QobjHeader(*\*\*kwargs*)" modifiers="class">
  ...
  **kwargs** – arbitrary keyword arguments that can be accessed as attributes of the object.
  ...
  <Function id="qiskit.qobj.QobjHeader.from_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/qobj/common.py#L41-L53" signature="from\_dict(*data*)" modifiers="classmethod">
  ...
  <Function id="qiskit.qobj.QobjHeader.to_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/qobj/common.py#L33-L39" signature="to\_dict()">
