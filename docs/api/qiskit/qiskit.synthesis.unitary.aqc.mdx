...
<Function id="qiskit.synthesis.unitary.aqc.make_cnot_network" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/synthesis/unitary/aqc/cnot_structures.py#L42-L111" signature="qiskit.synthesis.unitary.aqc.make\_cnot\_network(*num\_qubits*, *network\_layout='spin'*, *connectivity\_type='full'*, *depth=0*)">
