...
<Class id="qiskit.circuit.library.MSGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/generalized_gates/gms.py#L96-L121" signature="qiskit.circuit.library.MSGate(*num\_qubits*, *theta*, *label=None*)" modifiers="class">
