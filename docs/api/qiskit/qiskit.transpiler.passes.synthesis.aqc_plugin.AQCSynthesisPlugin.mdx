...
<Class id="qiskit.transpiler.passes.synthesis.aqc_plugin.AQCSynthesisPlugin" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/synthesis/aqc_plugin.py#L29-L153" signature="qiskit.transpiler.passes.synthesis.aqc\_plugin.AQCSynthesisPlugin" modifiers="class">
