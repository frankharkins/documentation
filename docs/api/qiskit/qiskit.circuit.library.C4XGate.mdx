...
<Class id="qiskit.circuit.library.C4XGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/x.py#L930-L1072" signature="qiskit.circuit.library.C4XGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.circuit.library.C4XGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/x.py#L1019-L1055" signature="control(*num\_ctrl\_qubits=1*, *label=None*, *ctrl\_state=None*, *annotated=False*)">
