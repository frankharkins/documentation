...
<Function id="qiskit.visualization.plot_state_paulivec" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/utils/lazy_tester.py#L611-L722" signature="qiskit.visualization.plot\_state\_paulivec(*state*, *title=''*, *figsize=None*, *color=None*, *ax=None*, *\**, *filename=None*)">
