...
<Class id="qiskit.qobj.QobjMeasurementOption" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/qobj/pulse_qobj.py#L28-L70" signature="qiskit.qobj.QobjMeasurementOption(*name*, *params=None*)" modifiers="class">
  ...
  *   **params** ([*list*](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.12)")) – The parameters of the measurement option.
  ...
  <Function id="qiskit.qobj.QobjMeasurementOption.from_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/qobj/pulse_qobj.py#L53-L64" signature="from\_dict(*data*)" modifiers="classmethod">
  ...
  <Function id="qiskit.qobj.QobjMeasurementOption.to_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/qobj/pulse_qobj.py#L42-L51" signature="to\_dict()">
