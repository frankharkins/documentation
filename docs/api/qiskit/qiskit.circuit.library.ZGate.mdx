...
<Class id="qiskit.circuit.library.ZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/z.py#L29-L147" signature="qiskit.circuit.library.ZGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.ZGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/z.py#L96-L127" signature="control(*num\_ctrl\_qubits=1*, *label=None*, *ctrl\_state=None*, *annotated=False*)">
