...
<Class id="qiskit.circuit.library.GraphState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/graph_state.py#L22-L86" signature="qiskit.circuit.library.GraphState(*adjacency\_matrix*)" modifiers="class">
