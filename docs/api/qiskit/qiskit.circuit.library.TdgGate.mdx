...
<Class id="qiskit.circuit.library.TdgGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/t.py#L102-L174" signature="qiskit.circuit.library.TdgGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
