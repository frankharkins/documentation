...
<Class id="qiskit.circuit.library.SdgGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/s.py#L106-L180" signature="qiskit.circuit.library.SdgGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
