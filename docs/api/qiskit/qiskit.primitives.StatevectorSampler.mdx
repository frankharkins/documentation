...
<Class id="qiskit.primitives.StatevectorSampler" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/statevector_sampler.py#L52-L200" signature="qiskit.primitives.StatevectorSampler(*\**, *default\_shots=1024*, *seed=None*)" modifiers="class">
