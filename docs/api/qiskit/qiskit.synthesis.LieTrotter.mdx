...
<Class id="qiskit.synthesis.LieTrotter" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/synthesis/evolution/lie_trotter.py#L23-L116" signature="qiskit.synthesis.LieTrotter(*reps=1*, *insert\_barriers=False*, *cx\_structure='chain'*, *atomic\_evolution=None*)" modifiers="class">
