...
<Class id="qiskit.circuit.library.UCRXGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/generalized_gates/ucrx.py#L20-L32" signature="qiskit.circuit.library.UCRXGate(*angle\_list*)" modifiers="class">
