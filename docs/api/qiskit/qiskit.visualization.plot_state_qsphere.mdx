...
<Function id="qiskit.visualization.plot_state_qsphere" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/utils/lazy_tester.py#L782-L1067" signature="qiskit.visualization.plot\_state\_qsphere(*state*, *figsize=None*, *ax=None*, *show\_state\_labels=True*, *show\_state\_phases=False*, *use\_degrees=False*, *\**, *filename=None*)">
