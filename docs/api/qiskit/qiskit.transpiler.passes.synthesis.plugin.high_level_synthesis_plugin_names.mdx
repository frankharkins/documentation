...
<Function id="qiskit.transpiler.passes.synthesis.plugin.high_level_synthesis_plugin_names" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/synthesis/plugin.py#L718-L734" signature="qiskit.transpiler.passes.synthesis.plugin.high\_level\_synthesis\_plugin\_names(*op\_name*)">
