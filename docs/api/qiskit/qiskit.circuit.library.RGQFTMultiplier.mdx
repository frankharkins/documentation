...
<Class id="qiskit.circuit.library.RGQFTMultiplier" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/arithmetic/multipliers/rg_qft_multiplier.py#L25-L101" signature="qiskit.circuit.library.RGQFTMultiplier(*num\_state\_qubits*, *num\_result\_qubits=None*, *name='RGQFTMultiplier'*)" modifiers="class">
  Bases: `Multiplier`
