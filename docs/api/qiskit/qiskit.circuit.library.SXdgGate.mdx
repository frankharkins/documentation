...
<Class id="qiskit.circuit.library.SXdgGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/sx.py#L138-L204" signature="qiskit.circuit.library.SXdgGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
