...
<Class id="qiskit.circuit.library.CZGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/z.py#L150-L241" signature="qiskit.circuit.library.CZGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
