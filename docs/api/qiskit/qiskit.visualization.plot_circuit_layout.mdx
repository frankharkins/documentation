...
<Function id="qiskit.visualization.plot_circuit_layout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/visualization/gate_map.py#L1120-L1224" signature="qiskit.visualization.plot\_circuit\_layout(*circuit*, *backend*, *view='virtual'*, *qubit\_coordinates=None*)">
