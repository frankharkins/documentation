...
<Function id="qiskit.visualization.timeline_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/utils/deprecation.py#L31-L424" signature="qiskit.visualization.timeline\_drawer(*program*, *style=None*, *time\_range=None*, *disable\_bits=None*, *show\_clbits=None*, *idle\_wires=None*, *plot\_barriers=None*, *show\_delays=None*, *show\_labels=True*, *plotter='mpl'*, *axis=None*, *filename=None*, *\**, *show\_idle=None*, *show\_barriers=None*)">
