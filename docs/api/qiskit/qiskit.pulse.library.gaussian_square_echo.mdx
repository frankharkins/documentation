...
<Function id="qiskit.pulse.library.gaussian_square_echo" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/library/symbolic_pulses.py#L1067-L1267" signature="qiskit.pulse.library.gaussian\_square\_echo(*duration*, *amp*, *sigma*, *width=None*, *angle=0.0*, *active\_amp=0.0*, *active\_angle=0.0*, *risefall\_sigma\_ratio=None*, *name=None*, *limit\_amplitude=None*)">
