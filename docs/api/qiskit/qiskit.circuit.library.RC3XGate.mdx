...
<Class id="qiskit.circuit.library.RC3XGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/x.py#L831-L927" signature="qiskit.circuit.library.RC3XGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
