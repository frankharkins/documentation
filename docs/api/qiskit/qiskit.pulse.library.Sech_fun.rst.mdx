...
<Function id="qiskit.pulse.library.Sech" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/library/symbolic_pulses.py#L1826-L1899" signature="qiskit.pulse.library.Sech(*duration*, *amp*, *sigma*, *angle=0.0*, *name=None*, *zero\_ends=True*, *limit\_amplitude=None*)">
