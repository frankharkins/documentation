...
<Class id="qiskit.circuit.InstructionSet" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/instructionset.py#L28-L180" signature="qiskit.circuit.InstructionSet(*\**, *resource\_requester=None*)" modifiers="class">
  ...
  **resource\_requester** (*Callable\[...,* [*ClassicalRegister*](circuit#qiskit.circuit.ClassicalRegister "qiskit.circuit.ClassicalRegister")  *|*[*Clbit*](circuit#qiskit.circuit.Clbit "qiskit.circuit.Clbit")*] | None*) –
  ...
  <Function id="qiskit.circuit.InstructionSet.c_if" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/instructionset.py#L108-L156" signature="c\_if(*classical*, *val*)">
