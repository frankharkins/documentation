...
<Class id="qiskit.qobj.QasmQobjConfig" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/qobj/qasm_qobj.py#L278-L403" signature="qiskit.qobj.QasmQobjConfig(*shots=None*, *seed\_simulator=None*, *memory=None*, *parameter\_binds=None*, *meas\_level=None*, *meas\_return=None*, *memory\_slots=None*, *n\_qubits=None*, *pulse\_library=None*, *calibrations=None*, *rep\_delay=None*, *qubit\_lo\_freq=None*, *meas\_lo\_freq=None*, *\*\*kwargs*)" modifiers="class">
  ...
  *   **kwargs** – Additional free form key value fields to add to the configuration.
  ...
  <Function id="qiskit.qobj.QasmQobjConfig.from_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/qobj/qasm_qobj.py#L378-L397" signature="from\_dict(*data*)" modifiers="classmethod">
  ...
  <Function id="qiskit.qobj.QasmQobjConfig.to_dict" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/qobj/qasm_qobj.py#L363-L376" signature="to\_dict()">
