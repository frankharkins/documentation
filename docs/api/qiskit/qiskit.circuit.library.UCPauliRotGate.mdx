...
<Class id="qiskit.circuit.library.UCPauliRotGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/generalized_gates/uc_pauli_rot.py#L32-L164" signature="qiskit.circuit.library.UCPauliRotGate(*angle\_list*, *rot\_axis*)" modifiers="class">
