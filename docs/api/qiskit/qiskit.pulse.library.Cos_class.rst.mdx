...
<Function id="qiskit.pulse.library.Cos" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/library/symbolic_pulses.py#L1556-L1617" signature="qiskit.pulse.library.Cos(*duration*, *amp*, *phase*, *freq=None*, *angle=0.0*, *name=None*, *limit\_amplitude=None*)">
  A cosine pulse.
