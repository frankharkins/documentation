...
<Function id="qiskit.visualization.plot_bloch_vector" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/utils/lazy_tester.py#L187-L251" signature="qiskit.visualization.plot\_bloch\_vector(*bloch*, *title=''*, *ax=None*, *figsize=None*, *coord\_type='cartesian'*, *font\_size=None*)">
