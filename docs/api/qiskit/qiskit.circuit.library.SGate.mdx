...
<Class id="qiskit.circuit.library.SGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/s.py#L29-L103" signature="qiskit.circuit.library.SGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
