...
<Class id="qiskit.synthesis.unitary.aqc.CNOTUnitObjective" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/synthesis/unitary/aqc/cnot_unit_objective.py#L27-L58" signature="qiskit.synthesis.unitary.aqc.CNOTUnitObjective(*num\_qubits*, *cnots*)" modifiers="class">
