...
<Function id="qiskit.visualization.dag_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/utils/lazy_tester.py#L29-L223" signature="qiskit.visualization.dag\_drawer(*dag*, *scale=0.7*, *filename=None*, *style='color'*)">
