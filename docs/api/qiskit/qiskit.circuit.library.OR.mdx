...
<Class id="qiskit.circuit.library.OR" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/boolean_logic/quantum_or.py#L22-L98" signature="qiskit.circuit.library.OR(*num\_variable\_qubits*, *flags=None*, *mcx\_mode='noancilla'*)" modifiers="class">
