...
<Function id="qiskit.visualization.visualize_transition" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/visualization/transition_visualization.py#L124-L364" signature="qiskit.visualization.visualize\_transition(*circuit*, *trace=False*, *saveas=None*, *fpg=100*, *spg=2*)">
