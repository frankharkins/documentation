...
<Class id="qiskit.dagcircuit.DAGNode" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/dagcircuit/dagnode.py#L178-L255" signature="qiskit.dagcircuit.DAGNode(*nid=-1*)" modifiers="class">
  ...
  <Function id="qiskit.dagcircuit.DAGNode.semantic_eq" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/dagcircuit/dagnode.py#L198-L255" signature="semantic\_eq(*node1*, *node2*, *bit\_indices1*, *bit\_indices2*)" modifiers="static">
