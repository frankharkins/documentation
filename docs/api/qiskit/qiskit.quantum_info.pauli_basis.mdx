...
<Function id="qiskit.quantum_info.pauli_basis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/quantum_info/operators/symplectic/pauli_utils.py#L21-L40" signature="qiskit.quantum\_info.pauli\_basis(*num\_qubits*, *weight=False*)">
