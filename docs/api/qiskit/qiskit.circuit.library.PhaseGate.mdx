...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.PhaseGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/p.py#L94-L127" signature="control(*num\_ctrl\_qubits=1*, *label=None*, *ctrl\_state=None*, *annotated=False*)">
