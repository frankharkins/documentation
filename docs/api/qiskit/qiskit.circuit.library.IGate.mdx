...
<Class id="qiskit.circuit.library.IGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/i.py#L20-L72" signature="qiskit.circuit.library.IGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
