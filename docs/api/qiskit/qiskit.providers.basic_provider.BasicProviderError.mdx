...
<Class id="qiskit.providers.basic_provider.BasicProviderError" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/providers/basic_provider/exceptions.py#L20-L30" signature="qiskit.providers.basic\_provider.BasicProviderError(*\*message*)" modifiers="exception">
