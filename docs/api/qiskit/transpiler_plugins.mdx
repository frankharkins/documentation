...
<Function id="qiskit.transpiler.preset_passmanagers.plugin.list_stage_plugins" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/preset_passmanagers/plugin.py#L283-L309" signature="qiskit.transpiler.preset\_passmanagers.plugin.list\_stage\_plugins(*stage\_name*)">
...
<Function id="qiskit.transpiler.preset_passmanagers.plugin.passmanager_stage_plugins" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/preset_passmanagers/plugin.py#L312-L353" signature="qiskit.transpiler.preset\_passmanagers.plugin.passmanager\_stage\_plugins(*stage*)">
