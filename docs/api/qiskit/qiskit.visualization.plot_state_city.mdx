...
<Function id="qiskit.visualization.plot_state_city" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/utils/lazy_tester.py#L360-L608" signature="qiskit.visualization.plot\_state\_city(*state*, *title=''*, *figsize=None*, *color=None*, *alpha=1*, *ax\_real=None*, *ax\_imag=None*, *\**, *filename=None*)">
