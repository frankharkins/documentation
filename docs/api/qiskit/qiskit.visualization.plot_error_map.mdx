...
<Function id="qiskit.visualization.plot_error_map" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/utils/lazy_tester.py#L1227-L1463" signature="qiskit.visualization.plot\_error\_map(*backend*, *figsize=(15, 12)*, *show\_title=True*, *qubit\_coordinates=None*)">
