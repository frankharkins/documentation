...
<Class id="qiskit.circuit.library.InnerProduct" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/boolean_logic/inner_product.py#L20-L78" signature="qiskit.circuit.library.InnerProduct(*num\_qubits*)" modifiers="class">
