...
<Class id="qiskit.circuit.library.GroverOperator" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/grover_operator.py#L25-L285" signature="qiskit.circuit.library.GroverOperator(*oracle*, *state\_preparation=None*, *zero\_reflection=None*, *reflection\_qubits=None*, *insert\_barriers=False*, *mcx\_mode='noancilla'*, *name='Q'*)" modifiers="class">
