...
<Class id="qiskit.circuit.library.UCRYGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/generalized_gates/ucry.py#L20-L32" signature="qiskit.circuit.library.UCRYGate(*angle\_list*)" modifiers="class">
