...
$$
  ...
  **options** ([*dict*](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.12)") *| None*) – Default options.
  ...
  <Function id="qiskit.primitives.BaseEstimatorV1.run" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/base/base_estimator.py#L120-L177" signature="run(*circuits*, *observables*, *parameter\_values=None*, *\*\*run\_options*)">
  ...
  <Function id="qiskit.primitives.BaseEstimatorV1.set_options" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/primitives/base/base_primitive.py#L39-L45" signature="set\_options(*\*\*fields*)">
