...
<Class id="qiskit.circuit.library.HGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/h.py#L24-L124" signature="qiskit.circuit.library.HGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
...
$$
  ...
  <Function id="qiskit.circuit.library.HGate.control" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/h.py#L76-L107" signature="control(*num\_ctrl\_qubits=1*, *label=None*, *ctrl\_state=None*, *annotated=False*)">
