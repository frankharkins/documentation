...
<Class id="qiskit.transpiler.passes.TranslateParameterizedGates" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/passes/basis/translate_parameterized.py#L29-L151" signature="qiskit.transpiler.passes.TranslateParameterizedGates(*\*args*, *\*\*kwargs*)" modifiers="class">
  ...
  **Raises**
  ...
  <Function id="qiskit.transpiler.passes.TranslateParameterizedGates.execute" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/basepasses.py#L189-L211" signature="execute(*passmanager\_ir*, *state*, *callback=None*)">
  ...
  <Function id="qiskit.transpiler.passes.TranslateParameterizedGates.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/transpiler/basepasses.py#L213-L221" signature="update\_status(*state*, *run\_state*)">
