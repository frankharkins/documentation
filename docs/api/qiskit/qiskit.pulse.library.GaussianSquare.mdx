...
<Class id="qiskit.pulse.library.GaussianSquare" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/pulse/library/symbolic_pulses.py" signature="qiskit.pulse.library.GaussianSquare(*duration*, *amp*, *sigma*, *width=None*, *angle=0.0*, *risefall\_sigma\_ratio=None*, *name=None*, *limit\_amplitude=None*)" modifiers="class">
