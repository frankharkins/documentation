...
<Class id="qiskit.circuit.library.CSGate" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/s.py#L183-L266" signature="qiskit.circuit.library.CSGate(*\*args*, *\_force\_mutable=False*, *\*\*kwargs*)" modifiers="class">
