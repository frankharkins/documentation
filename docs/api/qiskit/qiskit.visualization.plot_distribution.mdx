...
<Function id="qiskit.visualization.plot_distribution" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/visualization/counts_visualization.py#L165-L258" signature="qiskit.visualization.plot\_distribution(*data*, *figsize=(7, 5)*, *color=None*, *number\_to\_keep=None*, *sort='asc'*, *target\_string=None*, *legend=None*, *bar\_labels=True*, *title=None*, *ax=None*, *filename=None*)">
