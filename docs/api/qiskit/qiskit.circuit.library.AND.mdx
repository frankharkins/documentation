...
<Class id="qiskit.circuit.library.AND" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/boolean_logic/quantum_and.py#L21-L97" signature="qiskit.circuit.library.AND(*num\_variable\_qubits*, *flags=None*, *mcx\_mode='noancilla'*)" modifiers="class">
