...
$$
  ...
  **Examples:**
  ...
  <Function id="qiskit.circuit.library.U1Gate.control" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/standard_gates/u1.py#L114-L147" signature="control(*num\_ctrl\_qubits=1*, *label=None*, *ctrl\_state=None*, *annotated=False*)">
