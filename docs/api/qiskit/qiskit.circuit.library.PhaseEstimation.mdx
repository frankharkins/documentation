...
<Class id="qiskit.circuit.library.PhaseEstimation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/circuit/library/phase_estimation.py#L22-L99" signature="qiskit.circuit.library.PhaseEstimation(*num\_evaluation\_qubits*, *unitary*, *iqft=None*, *name='QPE'*)" modifiers="class">
