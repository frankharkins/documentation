...
<Function id="qiskit.visualization.pass_manager_drawer" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/utils/lazy_tester.py#L32-L101" signature="qiskit.visualization.pass\_manager\_drawer(*pass\_manager*, *filename=None*, *style=None*, *raw=False*)">
