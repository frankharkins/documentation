...
<Class id="qiskit.result.Counts" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/result/counts.py#L27-L189" signature="qiskit.result.Counts(*data*, *time\_taken=None*, *creg\_sizes=None*, *memory\_slots=None*)" modifiers="class">
  ...
  *   [**QiskitError**](exceptions#qiskit.exceptions.QiskitError "qiskit.exceptions.QiskitError") – If a dit string key is input with `creg_sizes` and/or `memory_slots`.
  ...
  <Function id="qiskit.result.Counts.hex_outcomes" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/result/counts.py#L137-L158" signature="hex\_outcomes()">
  ...
  <Function id="qiskit.result.Counts.int_outcomes" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/result/counts.py#L160-L180" signature="int\_outcomes()">
  ...
  <Function id="qiskit.result.Counts.most_frequent" github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/result/counts.py#L118-L135" signature="most\_frequent()">
