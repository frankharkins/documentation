...
<Class id="qiskit.passmanager.PassManagerState" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/1.1/qiskit/passmanager/compilation_status.py#L55-L74" signature="qiskit.passmanager.PassManagerState(*workflow\_status*, *property\_set*)" modifiers="class">
